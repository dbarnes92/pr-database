...
CREATE TABLE `head_to_head` (
  ...
  `p1_wins` int(11) DEFAULT 0,
  `p2_wins` int(11) DEFAULT 0,
  PRIMARY KEY (`id`),
  KEY `fk_player1_id` (`p1_id`),
  KEY `fk_player2_id` (`p2_id`),
  CONSTRAINT `fk_player1_id` FOREIGN KEY (`p1_id`) REFERENCES `player` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `fk_player2_id` FOREIGN KEY (`p2_id`) REFERENCES `player` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
